 ...
 * @returns {Match}
 */
function matchRoutes(routes, path, props, trace) {
  ...
  for (var i = 0, len = routes.length; i < len; i++) {
    ...
    if ((m._ && m._[0] || route.view === undefined) && route.children.length > 0) {
      return matchRoutes(route.children, m._ ? m._[0] : '/', nextProps, trace);
    } else {
