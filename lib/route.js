...
function Route(props) {
  ...
  var subView = props.subView;
  delete props.subView;
  ...
  var route = {path, name, view, subView, props, children, __scope};
...
function hasView(route) {
  return route.view !== undefined || route.subView !== undefined;
}
